...
export const HOURLY_RELEASE_REPO = 'ecurie-ai/orca-hourly'
export const DAILY_RELEASE_REPO = 'ecurie-ai/orca-daily'
export const ADHOC_RELEASE_REPO = 'ecurie-ai/orca-adhoc'
export const MAIN_RELEASE_REPO = 'ecurie-ai/orca'
