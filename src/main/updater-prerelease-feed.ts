...
const ATOM_FEED_URL = 'https://github.com/ecurie-ai/orca/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/ecurie-ai/orca/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/ecurie-ai\/orca\/releases\/tag\/([^"]+)"/g
